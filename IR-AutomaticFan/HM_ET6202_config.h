...
const uint8_t ET6202_TOTAL_DIGITS = 4;

//                              COLON  LED
const uint8_t ET6202_LED_ADDR[] = {0x04, 0x01};
const uint8_t ET6202_LED_VAL[]  = {0x80, 0x08};

const uint8_t ET6202_DIGIT_ADDR[ET6202_TOTAL_DIGITS] = {
...
struct HMD_config ET6202_config {

    .TOTAL_DIGITS = ET6202_TOTAL_DIGITS,
    .LED_ADDR = ET6202_LED_ADDR,
    .LED_VAL = ET6202_LED_VAL,
    .DIGIT_ADDR = ET6202_DIGIT_ADDR
};
